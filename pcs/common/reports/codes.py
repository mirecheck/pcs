...
CIB_NODE_RENAME_ACLS_EXIST = M("CIB_NODE_RENAME_ACLS_EXIST")
CIB_NODE_RENAME_ELEMENT_UPDATED = M("CIB_NODE_RENAME_ELEMENT_UPDATED")
CIB_NODE_RENAME_FENCING_LEVEL_PATTERN_EXISTS = M(
    "CIB_NODE_RENAME_FENCING_LEVEL_PATTERN_EXISTS"
)
CIB_NODE_RENAME_NEW_NODE_NOT_IN_COROSYNC = M(
    "CIB_NODE_RENAME_NEW_NODE_NOT_IN_COROSYNC"
)
CIB_NODE_RENAME_NO_CHANGE = M("CIB_NODE_RENAME_NO_CHANGE")
CIB_NODE_RENAME_OLD_NODE_IN_COROSYNC = M("CIB_NODE_RENAME_OLD_NODE_IN_COROSYNC")
...
CIB_RESOURCE_SECRET_UNABLE_TO_GET = M("CIB_RESOURCE_SECRET_UNABLE_TO_GET")
...
COROSYNC_CONFIG_DISABLING_ENCRYPTION_DEPRECATED = M(
    "COROSYNC_CONFIG_DISABLING_ENCRYPTION_DEPRECATED"
)
...
COROSYNC_NODE_RENAME_ADDRS_MATCH_OLD_NAME = M(
    "COROSYNC_NODE_RENAME_ADDRS_MATCH_OLD_NAME"
)
COROSYNC_NODE_RENAME_NEW_NODE_ALREADY_EXISTS = M(
    "COROSYNC_NODE_RENAME_NEW_NODE_ALREADY_EXISTS"
)
COROSYNC_NODE_RENAME_OLD_NODE_NOT_FOUND = M(
    "COROSYNC_NODE_RENAME_OLD_NODE_NOT_FOUND"
)
...
FILE_DOES_NOT_EXIST_USING_DEFAULT = M("FILE_DOES_NOT_EXIST_USING_DEFAULT")
...
INIT_SYSTEM_DOES_NOT_SUPPORT_SERVICE_INSTANCES = M(
    "INIT_SYSTEM_DOES_NOT_SUPPORT_SERVICE_INSTANCES"
)
...
NODE_RENAME_NAMES_EQUAL = M("NODE_RENAME_NAMES_EQUAL")
...
NOT_AUTHORIZED_TO_CHANGE_FULL_PERMISSION = M(
    "NOT_AUTHORIZED_TO_CHANGE_FULL_PERMISSION"
)
...
PERMISSION_DUPLICATION = M("PERMISSION_DUPLICATION")
...
USE_COMMAND_CLUSTER_RENAME = M("USE_COMMAND_CLUSTER_RENAME")
