    ...
    if name == "cluster":
        return bind_all(
            ...
            middleware.build(middleware_factory.cib),
            {
                ...
                "get_corosync_conf": cluster.get_corosync_conf,
                "get_corosync_conf_remote": cluster.get_corosync_conf_remote,
                ...
                "reload_corosync_conf": cluster.reload_corosync_conf,
                ...
                "rename_node_corosync": cluster.rename_node_corosync,
                "setup": cluster.setup,
